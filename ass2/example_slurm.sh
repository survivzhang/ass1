...
# Hybrid MPI+OpenMP Test - 2 Nodes, 2 cores, stride (2,2)
...
echo "=========================================="
echo "Hybrid MPI+OpenMP Test - 2 Nodes, 2 cores, stride (2,2)"
...
srun -n 2 ./conv_stride_test -H 20000 -W 20000 -kH 200 -kW 200 -sH 2 -sW 2 -m hybrid
