#!/bin/bash
#SBATCH --job-name=hybrid_20000_4n_c8
#SBATCH --nodes=4
#SBATCH --ntasks=4
#SBATCH --cpus-per-task=2
#SBATCH --mem=96G
#SBATCH --time=02:00:00
#SBATCH --output=hout/hybrid_20000_4n_c8_%j.out
#SBATCH --error=hout/hybrid_20000_4n_c8_%j.err
#SBATCH --partition=work

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Hybrid MPI+OpenMP Test - 4 Nodes, 8 cores, 20000x20000 matrix, kernel 200x200
...
echo "=========================================="
echo "Hybrid MPI+OpenMP Test - 4 Nodes, 8 cores"
echo "20000x20000 Matrix, Kernel 200x200"
echo "=========================================="
echo "Job started at: $(date)"
echo "MPI Processes: 4, OpenMP Threads: 2 (Total: 8 cores)"
