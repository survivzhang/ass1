#!/bin/bash
#SBATCH --job-name=hybrid_20k_s5_call
#SBATCH --nodes=2
#SBATCH --ntasks=12
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=output/hybrid_20k_s5_call_%j.out
#SBATCH --error=output/hybrid_20k_s5_call_%j.err
#SBATCH --partition=cits3402

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Hybrid MPI+OpenMP Test - 2 Nodes, all core counts, stride (5,5)

module load gcc/12.2.0
module load cray-mpich

echo "=========================================="
echo "Hybrid MPI+OpenMP Test - 2 Nodes, stride (5,5)"
...
for cores in "${CORES[@]}"; do
    ...
    srun -n $NTASKS ./conv_stride_test -H 20000 -W 20000 -kH 200 -kW 200 -sH 5 -sW 5 -m hybrid
done
