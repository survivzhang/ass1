#!/bin/bash
#SBATCH --job-name=pure_mpi_3nodes
#SBATCH --nodes=3
#SBATCH --ntasks=96
#SBATCH --cpus-per-task=1
#SBATCH --time=01:00:00
#SBATCH --output=pure_mpi_3nodes_%j.out
#SBATCH --error=pure_mpi_3nodes_%j.err
#SBATCH --partition=cits3402

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Pure MPI Test - 3 Nodes with varying core counts: 3, 6, 12, 24, 48, 96
