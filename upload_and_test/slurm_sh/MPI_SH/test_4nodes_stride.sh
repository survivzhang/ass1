#!/bin/bash
#SBATCH --job-name=pure_mpi_4nodes_stride
#SBATCH --nodes=4
#SBATCH --ntasks=96
#SBATCH --cpus-per-task=1
#SBATCH --time=01:00:00
#SBATCH --output=pure_mpi_4nodes_stride_%j.out
#SBATCH --error=pure_mpi_4nodes_stride_%j.err
#SBATCH --partition=cits3402

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Pure MPI Test - 4 Nodes with different stride values
...
echo "=========================================="
echo "Pure MPI Stride Test - 4 Nodes"
echo "=========================================="
