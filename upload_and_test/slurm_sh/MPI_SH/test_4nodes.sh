#!/bin/bash
#SBATCH --job-name=pure_mpi_4nodes
#SBATCH --nodes=4
#SBATCH --ntasks=96
#SBATCH --cpus-per-task=1
#SBATCH --time=01:00:00
#SBATCH --output=pure_mpi_4nodes_%j.out
#SBATCH --error=pure_mpi_4nodes_%j.err
#SBATCH --partition=cits3402

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Pure MPI Test - 4 Nodes with varying core counts: 4, 8, 16, 32, 64, 96
