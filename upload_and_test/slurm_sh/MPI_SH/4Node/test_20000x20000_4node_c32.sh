#!/bin/bash
#SBATCH --job-name=mpi_20000_4n_c32
#SBATCH --nodes=4
#SBATCH --ntasks=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=96G
#SBATCH --time=02:00:00
#SBATCH --output=../output/mpi_20000_4n_c32_%j.out
#SBATCH --error=../output/mpi_20000_4n_c32_%j.err
#SBATCH --partition=work

# Group Member: Jiazheng Guo(24070858), Zichen Zhang(24064091)
# Pure MPI Test - 4 Nodes, 32 cores, 20000x20000 matrix, kernel 200x200
...
echo "=========================================="
echo "Pure MPI Test - 4 Nodes, 32 cores"
