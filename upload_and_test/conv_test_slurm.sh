...
srun -n $SLURM_NTASKS ./conv_stride_test -H 1000 -W 1000 -kH 3 -kW 3 -sH 1 -sW 1 -m hybrid

echo ""
echo "Test 2: Medium matrix with stride (2000x2000, kernel 5x5, stride 2x2)"
srun -n $SLURM_NTASKS ./conv_stride_test -H 2000 -W 2000 -kH 5 -kW 5 -sH 2 -sW 2 -m hybrid

echo ""
echo "Test 3: Large matrix (4000x4000, kernel 7x7, stride 1x1)"
srun -n $SLURM_NTASKS ./conv_stride_test -H 4000 -W 4000 -kH 7 -kW 7 -sH 1 -sW 1 -m hybrid
...
echo "Serial:"
srun -n 1 ./conv_stride_test -H 2000 -W 2000 -kH 5 -kW 5 -sH 1 -sW 1 -m serial

echo ""
echo "OpenMP only:"
srun -n 1 ./conv_stride_test -H 2000 -W 2000 -kH 5 -kW 5 -sH 1 -sW 1 -m omp

echo ""
echo "MPI only:"
srun -n $SLURM_NTASKS ./conv_stride_test -H 2000 -W 2000 -kH 5 -kW 5 -sH 1 -sW 1 -m mpi

echo ""
echo "Hybrid MPI+OpenMP:"
srun -n $SLURM_NTASKS ./conv_stride_test -H 2000 -W 2000 -kH 5 -kW 5 -sH 1 -sW 1 -m hybrid
